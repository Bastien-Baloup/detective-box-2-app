...
export const MarzipanoInit = (panoRef, viewerRef, data) => {
  ...
  const createLinkHotspotElement = (hotspot) => {
    ...
    icon.src = import.meta.env.BASE_URL + "fouilles/chantier/img/link.png";
  ...
  const createInfoHotspotElement = (hotspot) => {
    ...
    const icon = document.createElement("img");
    icon.src = import.meta.env.BASE_URL + "fouilles/chantier/img/info.png";
    ...
    closeIcon.src =
      import.meta.env.BASE_URL + "fouilles/chantier/img/close.png";
  ...
  const scenes = data.scenes.map((data) => {
    const urlPrefix = import.meta.env.BASE_URL + "fouilles/chantier/tiles";
