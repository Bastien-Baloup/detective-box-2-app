		...
		return (
			<div className='modal-forgot__background'>
				<div className='modal-forgot__box'>
					<button type='button' className='modal-forgot__icon--container'>
					...
					<form className='modal-forgot__form' onSubmit={handleSubmitEmailForgot}>
						...
						/>
						<button type='submit' className='modal-password__button button--red' disabled={emailForgotButtonIsDisabled}>
							Valider
						</button>
					</form>
				</div>
		...
		<>
			<section className='signin'>
				<p className='signin__instructions'>
					Vous avez déjà résolu notre première enquête &quot;Woodlock University&quot; ? Vous devrez tout de même vous
					créer un nouveau compte pour partir en chasse du Tueur au Tarot.
				</p>
				...
				<form className='signin__form' onSubmit={handleSubmitSignin}>
					...
					/>
					<button type='submit' className='signin__form__button button--red'>
						Connexion
					</button>
				</form>
				<button type='button' className='signin__forget' onClick={() => setModalActive(true)}>
					Mot de passe oublié ?
				</button>
				<button type='button' className='signin__button__signup button--white' onClick={switchToSignup}>
					Créer un compte
				</button>
			</section>
