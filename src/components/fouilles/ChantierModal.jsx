...
function ChantierModal({ onClose }) {
  ...
  useEffect(() => MarzipanoInit(panoRef, viewerRef, data), [])
    ...
    >
      <div id="fouille" className="multiple-scenes">
        ...
        <button
          ...
          style={{ position: 'fixed', bottom: '0.5rem', left: '0.5rem', zIndex: 10000}}
          onClick={onClose}
        >
          fermer
        </button>
      </div>
      <div id="malle-container" style={{ display: 'none', width: '100%', height: '100%', backgroundColor: 'black', position: 'fixed' }}>
      ...
      <div id="open-malle-container" style={{ display: 'none', width: '100%', height: '100%', backgroundColor: 'black', position: 'fixed' }}>
