...
const Objectif = ({ data }) => {
	...
	const setObjectifs = (objectifs) => {
		...
		if (currentBox == 3) {
			const objectif33 = objectifs.data.find((event) => event.id == 33);
			setObjectif33(objectif33.status);
