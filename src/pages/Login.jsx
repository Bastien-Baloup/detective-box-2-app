...
function Login() {
	...
	const [emailForgotButtonIsDisabled, setEmailForgotButtonIsDisabled] = useState(false)
	...
	const handleSubmitEmailForgot = async (e) => {
		...
		setEmailForgotButtonIsDisabled(true)
		...
		setEmailForgotButtonIsDisabled(false)
	}
		...
		return (
			<div className='modal-confirm__background'>
				<div className='modal-confirm__box'>
					...
					<button type='button' className='modal-confirm__button button--red' onClick={handleModalNewUser}>
						Se connecter
					</button>
				</div>
			</div>
		...
		<main className='login'>
			...
			{isSigninActive ? (
				<Signin
					...
					emailForgotButtonIsDisabled={emailForgotButtonIsDisabled}
				/>
			) : (
				<Signup
